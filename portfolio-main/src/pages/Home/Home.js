      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        <Grid2 container spacing={4} alignItems="center">
          <Grid2 xs={12} md={6}>
            ...
            <Box sx={{ color: 'text.secondary', mt: 2, minHeight: '60px' }}>
              <a href="https://github.com/DenverCoder1/readme-typing-svg" target="_blank" rel="noreferrer">
                <img
                  src="https://readme-typing-svg.herokuapp.com?font=IBM+Plex+Sans&color=38BDF8&size=25&lines=Data+Scientist;AI+Enthusiast;Machine+Learning+%26+NLP;Turning+Data+into+Impact"
                  alt="Typing SVG"
                  style={{ maxWidth: '100%' }}
                />
              </a>
